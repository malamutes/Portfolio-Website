...
export default function CurtinEducationDescription() {
    return (
        <div className="EducationDescription OpacityToggle CurtinDescription">
            ...
            Topics: Operating Systems, C, Unix, Kotlin, Java, Python, Data Mining, Datastructures, Research
        </div>
    );
}
...
export function AXHSEducationDescription() {
    return (
        <div className="EducationDescription OpacityToggle">
